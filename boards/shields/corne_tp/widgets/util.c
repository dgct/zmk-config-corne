...
void draw_battery(lv_obj_t *canvas, const struct status_state *state) {
    ...
    // Single 13px-tall battery with internal divider
    canvas_draw_rect(canvas, 0, 2, 29, 13, &rect_white_dsc);   // outer border
    ...
    canvas_draw_rect(canvas, 30, 6, 3, 5, &rect_white_dsc);
    canvas_draw_rect(canvas, 31, 7, 1, 3, &rect_black_dsc);
